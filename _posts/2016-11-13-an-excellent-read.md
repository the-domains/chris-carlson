---
datePublished: '2016-11-13T08:37:16.553Z'
inFeed: true
hasPage: true
keywords: []
related: []
...
via: {}
dateModified: '2016-11-13T08:36:34.290Z'
title: An Excellent Read
app_links: []
publisher:
  url: 'http://eloquentjavascript.net'
  name: Eloquentjavascript
  favicon: 'http://eloquentjavascript.net/favicon.ico'
  domain: eloquentjavascript.net
description: 'Stumbled into this tonight. Maybe my new favorite programming book. '
starred: false
...
---
# An Excellent Read
![](https://s3-us-west-2.amazonaws.com/the-grid-img/p/288a3382e34e0f0d7e455f186b74e61222f6c480.png)

Stumbled into this tonight. Maybe my new favorite programming book. 

---

Eloquent Javascript is joy to read. The programming examples are easy to follow, but not mundane; The lessons build on each other naturally; The writing style is clear and concise; And the anecdotes and musings of Marijn Haverbeke are a great combination of interesting, humorous, and profound. 

My favorite part so far is in chapter six, when he tells the tale of a Transylvanian Recluse struck with a drive to write a novel. The story goes that, "After failing miserably at poetry, fiction, and philosophy, the recluse finally decided to write a technical book", whereupon he settles on computer programming. 

Then he is suddenly struck by lightening and killed. This happens after only six months of writing, (The man had struggled and only finished a few paragraphs meanwhile). 

The remaining paragraphs are recovered from the Recluse's computer, and Marijn pauses his programming narrative to include them, uninterupted and in their original formatting, over the next few pages of the book. This is what they say:
